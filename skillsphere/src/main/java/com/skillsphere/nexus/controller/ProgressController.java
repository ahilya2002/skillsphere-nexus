...
import com.skillsphere.nexus.service.ProgressService;
...
public class ProgressController {
    ...
    public Enrollment submitAssessment(@PathVariable UUID enrollmentId, @RequestParam Float score) {
        return progressService.submitAssessment(enrollmentId, score);
    }

    @PostMapping("/{enrollmentId}/complete")
    public Enrollment completeCourse(@PathVariable UUID enrollmentId) {
