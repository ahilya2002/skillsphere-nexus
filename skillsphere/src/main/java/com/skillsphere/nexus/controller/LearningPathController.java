...
import com.skillsphere.nexus.service.LearningPathService;
...
public class LearningPathController {
    ...
    public LearningPath addCourse(@PathVariable UUID pathId, @PathVariable UUID courseId, @RequestParam Integer sequence) {
        return learningPathService.addCourseToPath(pathId, courseId, sequence);
    }

    @GetMapping("/{pathId}/courses")
    public List<LearningPathCourse> getCourses(@PathVariable UUID pathId) {
